...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let bob = arr.map(i => Math.pow(2, i));
  return bob;
};
...
const charCode = (arr) => {
  // Solution code here...
  let bob = arr.map(x => x.charCodeAt());
  return bob;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  let bob = arr.map(x => dataDrop(x));
  return bob;
};

const dataDrop = function(x){
  let y = x % 2;
  let val1 = 'odd';
  let val2 = 'even';
  let val3 = 'N/A'
...
const extractAbilities = (arr) => {
  // Solution code here...
  let bob = arr.map(x => x.ability.name);
  return bob;
};
