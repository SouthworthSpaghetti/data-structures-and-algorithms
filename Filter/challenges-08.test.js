...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let regex = /[aeiou]/;
  let newArr = arr.filter(string => string.match(regex));
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArr = arr.filter(i => !forbiddenValues.includes(i));
  return newArr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = arr.filter(i => i.baseStat > minBaseStat);
  // where i is the parent of j.baseSatat > minBaseStat
  // let newArr = arr.filter(i => {
  //   if(i.baseStat > minBaseStat){
  //     return i.stat.name;
  //   }});
  return newArr;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = arr.filter(i => i.baseStat > minBaseStat);
  return newArr.map(i => i.stat.name);
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  return arr.filter(i => !i.children)
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let newArr = arr.filter(i => !isNaN(i));
  newArr = arr.filter(i => String(i) !== i);
  console.log(newArr);
  return newArr.map(j => intId(j));
};

const intId = function(x){
